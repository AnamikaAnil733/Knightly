            ...
            {puzzles.map((puzzle) => (
              ...
              >
                ...
                <td className="px-4 py-3 text-sm">
                  <span
                    className={`px-2 py-1 rounded text-xs font-medium ${puzzle.difficulty === 'Easy' ? 'bg-green-900/40 text-green-300' : puzzle.difficulty === 'Medium' ? 'bg-blue-900/40 text-blue-300' : puzzle.difficulty === 'Hard' ? 'bg-orange-900/40 text-orange-300' : 'bg-red-900/40 text-red-300'}`}
                  >
                    {puzzle.difficulty}
                  </span>
                </td>
