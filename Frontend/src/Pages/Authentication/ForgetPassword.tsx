  ...
  return (
    <div className="relative min-h-screen w-full bg-[#0A0F2C] overflow-hidden flex items-center justify-center">
      ...
      <div className="relative z-10 w-full max-w-md px-6">
        ...
        {/* Card */}
        <div
          className="relative bg-[#11193F]/80 backdrop-blur-sm rounded-2xl p-10 border border-transparent"
          style={{
            boxShadow: "0px 0px 12px rgba(106,46,255,0.3)",
            borderImage: "linear-gradient(135deg, #3A6FF7, #6B2EFF) 1",
          }}
        >
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div>
              <label
                htmlFor="email"
                className="block text-white mb-3 text-sm font-medium"
                style={{ fontFamily: "Inter, sans-serif" }}
              >
            ...
            <button
              ...
              style={{
                ...
                boxShadow: "0px 0px 8px rgba(106, 46, 255, 0.4)",
              }}
            >
