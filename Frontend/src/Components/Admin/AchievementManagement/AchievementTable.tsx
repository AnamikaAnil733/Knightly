    ...
    return (
      <div className="rounded-2xl border border-white/10 bg-[#0A0F2C]/60 overflow-hidden">
        <div className="p-12 flex flex-col items-center gap-4 text-center">
          <div
            className="w-16 h-16 rounded-2xl bg-gradient-to-br from-[#6B2EFF]/20 to-[#3A6FF7]/20
  ...
  return (
    <div className="rounded-2xl border border-white/10 bg-[#0A0F2C]/60 overflow-hidden">
      ...
      <div className="divide-y divide-white/5">
        {achievements.map((a) => {
          const IconComponent =
            ICON_OPTIONS.find((i) => i.name === a.icon)?.Component ?? Trophy;
          const colorClass =
            CRITERIA_COLORS[a.criteriaType] ??
          ...
          return (
            ...
            >
              ...
              <div>
                ...
                >
                  {CRITERIA_OPTIONS.find((c) => c.value === a.criteriaType)
                    ?.label ?? a.criteriaType}
                </span>
              </div>
