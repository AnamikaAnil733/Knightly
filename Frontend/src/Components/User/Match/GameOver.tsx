...
export function GameOver({
  ...
  const theme = {
    win: {
      title: "Victory!",
      subtitle:
        status === "WHITE_RESIGNED" || status === "BLACK_RESIGNED"
          ? "Opponent Resigned"
          : "You won the Chess Championship",
      titleColor: "#ffffff",
        ...
        <div className="flex flex-col items-center px-8 pt-10 pb-8">
          ...
          >
            ...
            <button
              ...
              onClick={() =>
                navigate("/waiting", { state: { format, modeName } })
              }
            >
